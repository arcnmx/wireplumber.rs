...
pub const WP_OBJECT_FORMAT: *const c_char = b"<%s:%p>\0" as *const u8 as *const c_char;
...
#[repr(C)]
pub struct WpObjectInterest(c_void);
...
#[repr(C)]
pub struct WpProperties(c_void);
...
#[repr(C)]
pub struct WpPropertiesItem(c_void);
...
#[repr(C)]
pub struct WpSpaPodBuilder(c_void);
...
#[repr(C)]
pub struct WpSpaPodParser(c_void);
...
#[repr(C)]
pub struct WpFeatureActivationTransition(c_void);
...
#[repr(C)]
pub struct WpImplEndpoint(c_void);
...
#[repr(C)]
pub struct WpImplMetadata(c_void);
...
#[repr(C)]
pub struct WpImplModule(c_void);
...
#[repr(C)]
pub struct WpObjectManager(c_void);
...
pub type WpSpaType = c_uint;

#[repr(C)]
pub struct WpState(c_void);
...
// Interfaces
#[repr(C)]
pub struct WpPipewireObject(c_void);
...
#[repr(C)]
pub struct WpSiAcquisition(c_void);
...
#[repr(C)]
pub struct WpSiEndpoint(c_void);
...
#[repr(C)]
pub struct WpSiLinkable(c_void);
