...
impl<O: IsA<SessionItem>> SessionItemExt for O {
    ...
    #[doc(alias = "id")]
    fn connect_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpSessionItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<SessionItem>
        {
    ...
    #[doc(alias = "properties")]
    fn connect_properties_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_properties_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpSessionItem, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<SessionItem>
        {
            let f: &F = &*(f as *const F);
            f(&SessionItem::from_glib_borrow(this).unsafe_cast_ref())
