...
use crate::{Object,ObjectManager,Properties,SpaJson};
...
impl Core {
    ...
    //pub fn new(context: Option<&glib::MainContext>, conf: /*Ignored*/Option<Conf>, properties: Option<Properties>) -> Core {
    ...
    //#[doc(alias = "get_conf")]
    //pub fn conf(&self) -> /*Ignored*/Option<Conf> {
    //    unsafe { TODO: call ffi:wp_core_get_conf() }
    //}
...
#[must_use]
    ...
    pub fn load_component<P: FnOnce(Result<(), glib::Error>) + 'static>(&self, component: Option<&str>, type_: &str, args: Option<&SpaJson>, provides: Option<&str>, cancellable: Option<&impl IsA<gio::Cancellable>>, callback: P) {
        ...
        unsafe extern "C" fn load_component_trampoline<P: FnOnce(Result<(), glib::Error>) + 'static>(_source_object: *mut glib::gobject_ffi::GObject, res: *mut gio::ffi::GAsyncResult, user_data: glib::ffi::gpointer) {
    ...
    pub fn load_component_future(&self, component: Option<&str>, type_: &str, args: Option<&SpaJson>, provides: Option<&str>) -> Pin<Box_<dyn std::future::Future<Output = Result<(), glib::Error>> + 'static>> {
