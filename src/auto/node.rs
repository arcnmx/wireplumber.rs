...
impl Node {
    ...
    pub fn connect_ports_changed<F: Fn(&Node) + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_state_changed<F: Fn(&Node, NodeState, NodeState) + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "max-input-ports")]
    pub fn connect_max_input_ports_notify<F: Fn(&Node) + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "max-output-ports")]
    pub fn connect_max_output_ports_notify<F: Fn(&Node) + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_n_input_ports_notify<F: Fn(&Node) + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    pub fn connect_n_output_ports_notify<F: Fn(&Node) + 'static>(&self, f: F) -> SignalHandlerId {
    ...
    #[doc(alias = "state")]
    pub fn connect_state_notify<F: Fn(&Node) + 'static>(&self, f: F) -> SignalHandlerId {
