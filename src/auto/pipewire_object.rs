...
pub trait PipewireObjectExt: 'static {
    ...
    //fn enum_params<P: FnOnce(Result<Option<Iterator>, glib::Error>) + Send + 'static>(&self, id: Option<&str>, filter: Option<&SpaPod>, cancellable: /*Ignored*/Option<&gio::Cancellable>, callback: P);
