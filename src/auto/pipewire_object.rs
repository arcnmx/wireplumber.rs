...
pub trait PipewireObjectExt: 'static {
    ...
    //fn enum_params<P: FnOnce(Result<Option<Iterator>, /*Ignored*/glib::Error>) + Send + 'static>(&self, id: Option<&str>, filter: Option<&SpaPod>, cancellable: /*Ignored*/Option<&gio::Cancellable>, callback: P);

    //
    //fn enum_params_future(&self, id: Option<&str>, filter: Option<&SpaPod>) -> Pin<Box_<dyn std::future::Future<Output = Result<Option<Iterator>, /*Ignored*/glib::Error>> + 'static>>;
    ...
    //fn param_info(&self) -> /*Ignored*/Option<glib::Variant>;
...
impl<O: IsA<PipewireObject>> PipewireObjectExt for O {
    ...
    //fn param_info(&self) -> /*Ignored*/Option<glib::Variant> {
    //    unsafe { TODO: call ffi:wp_pipewire_object_get_param_info() }
    //}
    ...
    #[doc(alias = "params-changed")]
    fn connect_params_changed<F: Fn(&Self, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn params_changed_trampoline<P, F: Fn(&P, &str) + 'static>(this: *mut ffi::WpPipewireObject, object: *mut libc::c_char, f: glib::ffi::gpointer)
            where P: IsA<PipewireObject>
        {
    ...
    #[doc(alias = "native-info")]
    fn connect_native_info_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_native_info_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpPipewireObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<PipewireObject>
        {
            let f: &F = &*(f as *const F);
    ...
    #[doc(alias = "param-info")]
    fn connect_param_info_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_param_info_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpPipewireObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<PipewireObject>
        {
            let f: &F = &*(f as *const F);
            f(&PipewireObject::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[doc(alias = "properties")]
    fn connect_properties_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_properties_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpPipewireObject, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<PipewireObject>
        {
            let f: &F = &*(f as *const F);
            f(&PipewireObject::from_glib_borrow(this).unsafe_cast_ref())
