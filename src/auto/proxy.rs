...
impl<O: IsA<Proxy>> ProxyExt for O {
    ...
    #[doc(alias = "bound")]
    fn connect_bound<F: Fn(&Self, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn bound_trampoline<P, F: Fn(&P, u32) + 'static>(this: *mut ffi::WpProxy, object: libc::c_uint, f: glib::ffi::gpointer)
            where P: IsA<Proxy>
        {
    ...
    #[doc(alias = "error")]
    fn connect_error<F: Fn(&Self, i32, i32, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn error_trampoline<P, F: Fn(&P, i32, i32, &str) + 'static>(this: *mut ffi::WpProxy, object: libc::c_int, p0: libc::c_int, p1: *mut libc::c_char, f: glib::ffi::gpointer)
            where P: IsA<Proxy>
        {
            let f: &F = &*(f as *const F);
    ...
    #[doc(alias = "pw-proxy-destroyed")]
    fn connect_pw_proxy_destroyed<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn pw_proxy_destroyed_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpProxy, f: glib::ffi::gpointer)
            where P: IsA<Proxy>
        {
            let f: &F = &*(f as *const F);
    ...
    #[doc(alias = "bound-id")]
    fn connect_bound_id_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_bound_id_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpProxy, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Proxy>
        {
            let f: &F = &*(f as *const F);
            f(&Proxy::from_glib_borrow(this).unsafe_cast_ref())
    ...
    #[doc(alias = "pw-proxy")]
    fn connect_pw_proxy_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn notify_pw_proxy_trampoline<P, F: Fn(&P) + 'static>(this: *mut ffi::WpProxy, _param_spec: glib::ffi::gpointer, f: glib::ffi::gpointer)
            where P: IsA<Proxy>
        {
            let f: &F = &*(f as *const F);
            f(&Proxy::from_glib_borrow(this).unsafe_cast_ref())
