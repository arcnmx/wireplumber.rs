...
impl Properties {
    ...
    pub fn new_json(json: &SpaJson) -> Properties {
        unsafe {
            from_glib_full(ffi::wp_properties_new_json(json.to_glib_none().0))
        }
    }
...
#[allow(dead_code)]    pub(crate) fn items_iterator(&self) -> Option<Iterator> {
    ...
    pub fn update_from_json(&self, json: &SpaJson) -> i32 {
        unsafe {
            ffi::wp_properties_update_from_json(self.to_glib_none().0, json.to_glib_none().0)
        }
    }
