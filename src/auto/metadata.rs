...
impl Metadata {
    ...
    //pub fn iterator_item_extract(item: /*Ignored*/&glib::Value) -> (u32, glib::GString, glib::GString, glib::GString) {
    //    unsafe { TODO: call ffi:wp_metadata_iterator_item_extract() }
    //}
}
...
impl<O: IsA<Metadata>> MetadataExt for O {
    ...
    #[doc(alias = "changed")]
    fn connect_changed<F: Fn(&Self, u32, &str, &str, &str) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe extern "C" fn changed_trampoline<P, F: Fn(&P, u32, &str, &str, &str) + 'static>(this: *mut ffi::WpMetadata, object: libc::c_uint, p0: *mut libc::c_char, p1: *mut libc::c_char, p2: *mut libc::c_char, f: glib::ffi::gpointer)
            where P: IsA<Metadata>
        {
