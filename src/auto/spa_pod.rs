...
impl SpaPod {
    ...
    pub fn ensure_unique_owner(&self) -> Option<SpaPod> {
        unsafe {
            from_glib_full(ffi::wp_spa_pod_ensure_unique_owner(self.to_glib_full()))
        }
    }
    ...
    //pub fn spa_type(&self) -> /*Ignored*/Option<SpaType> {
    //    unsafe { TODO: call ffi:wp_spa_pod_get_spa_type() }
    //}
