...
pub trait ObjectExt: 'static {
    ...
    //fn activate<P: FnOnce(Result<(), glib::Error>) + Send + 'static>(&self, features: ObjectFeatures, cancellable: /*Ignored*/Option<&gio::Cancellable>, callback: P);
    ...
    //fn activate_closure(&self, features: ObjectFeatures, cancellable: /*Ignored*/Option<&gio::Cancellable>, closure: &glib::Closure);
