...
impl SpaProps {
	...
	pub fn has_volume(&self) -> bool {
		self
			.params
			.find_spa_property(&libspa_sys::spa_prop_SPA_PROP_channelVolumes)
			.is_some()
			|| self
				.params
				.find_spa_property(&libspa_sys::spa_prop_SPA_PROP_volume)
				.is_some()
	}
	...
	pub fn mute(&self) -> bool {
		self
			.params
			.find_spa_property(&libspa_sys::spa_prop_SPA_PROP_mute)
